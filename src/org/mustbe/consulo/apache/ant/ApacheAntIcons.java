...
public interface ApacheAntIcons
{
	...
	Icon Properties = IconLoader.getIcon("/icons/properties.png");  // 16x16
	Icon Target = IconLoader.getIcon("/icons/target.png");  // 16x16
	Icon Task = IconLoader.getIcon("/icons/task.png");  // 16x16
	Icon ToolWindowAnt = IconLoader.getIcon("/icons/toolWindowAnt.png");  // 13x13
	Icon Verbose = IconLoader.getIcon("/icons/verbose.png");  // 16x16
}
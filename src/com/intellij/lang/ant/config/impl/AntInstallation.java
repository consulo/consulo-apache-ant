...
public class AntInstallation
{
	...
	public static final AbstractProperty<String> VERSION = new StringProperty("version", AntBundle.message("ant.unknown.version.string" +
			".presentation"));
	@NonNls
	...
	private static Properties loadProperties(File antJar) throws MalformedURLException, ConfigurationException
	{
		try
		{
			return AntVersionUtil.loadProperties(antJar);
		}
		catch(IOException e)
		{
